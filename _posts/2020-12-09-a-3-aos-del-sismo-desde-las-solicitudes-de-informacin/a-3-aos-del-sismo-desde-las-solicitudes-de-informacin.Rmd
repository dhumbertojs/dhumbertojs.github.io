---
title: "A 3 años del sismo... desde las solicitudes de información"
description: |
...
Puse un punto **"."** porque para publicar esto r siempre me pone un directorio *default*, entonces el punto signfica lo mismo que copiar este directorio. Y quiero que exploremos esta manera de utilizar directorios.
...
En otras palabras, el .x es la variable que ira cambiando hasta que termine de leer los archivos. 
