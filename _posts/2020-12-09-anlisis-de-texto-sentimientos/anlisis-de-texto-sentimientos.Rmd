---
title: "AnÃ¡lisis de texto:  sentimientos"
description: |
...
Todas las ideas de análisis de texto vienen del increíble texto de [Julia Silge](https://twitter.com/juliasilge?lang=es): [*Text Mining with R*](https://www.tidytextmining.com/). Hay un montón de material para investigar de como hacer análisis de texto en inglés. Análisis en español replicables también hay pero no todos son tan amigables (que es algo que yo siempre intento). Voy a utilizar el mismo conjuto de datos de la entrada anterior y que pueden descargar [aquí](https://drive.google.com/file/d/18xlleEAl2SLeUIsKJmBcN6ImLxChvJqa/view?usp=sharing)).
