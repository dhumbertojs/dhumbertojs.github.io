...
description: |
  Código para la elaboración de mapas en los distritos locales y federales del estado de Sinaloa con información de las elecciones 2018 y algunos resultados del censo 2020. Si quieren saber más del proceso electoral en el estado, vayan a [arresinaloa](https://arresinaloa.com/).
author:
...
Estos son datos de rsultados electorales en los distritos locales (24) de Sinaloa.
...
Y estos de los siete distritos federales, a los que les agregué el nombre de la diputada o diputado, por MR, que busca la reelección en ese distrito.
...
Estos son los archivos finales ya con los datos agregados. Ahora, empecemos a jugar con los mapas.
...
Por último, le agregamos color a los mapas. En este caso, también podríamos hacer mapas de cloropetas, ya que tenemos información númerica que podemos agregar en categorías. Pero, quiero probar algo: mapas interactivos!
...
Por último, vamos a ponerlos juntos para verlos más fácil.
