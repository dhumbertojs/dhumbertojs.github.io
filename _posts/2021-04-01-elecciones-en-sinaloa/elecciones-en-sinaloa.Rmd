...
mapa_local <- tm_shape(sin_local) +
  tm_polygons(col = "partido") +
  tm_layout(main.title = "Diputados locales de Mayoría Relativa")

mapa_local
```

Por último, vamos a ponerlos juntos para verlos más fácil. Nota: No es más fácil verlos, pero pues aquí está el código.
